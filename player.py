...
class Player(Object):
    ...
    def check_collision(self, level):
        ...
        for cube in level:
            # CHECK X
            # LEFT OF D. -50 < 
            #if self.rect[0] <= cube.rect[0] + cube.rect[3] <= self.rect[0] + cube.rect[2]:
            if self.rect[0] + self.rect[2] >= cube.rect[0] and self.rect[0] <= cube.rect[0] + cube.rect[2]:
                ...
                # TOP OF PLAYER < BOTTOM OF CUBE
                # NOT TOP OF PLAYER < TOP OF CUBE
                # TOP OF PLAYER > BOTTOM OF CUBE - HEIGHT OF CUBE
                # TOP OF PLAYER + HEIGHT OF CUBE 
